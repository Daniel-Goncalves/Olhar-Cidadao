...
class Validation():
  ...
  def validate_products(self):
    ...
    if flag_corruption:
      ...
      suspect_data = { "date" : time.strftime("%x"), "suspect_product" : product_name, "suspect_price" : price }
